...
/* ****************************************************************************
 * Function that calculates the all the forces, the total viral and the total 
 * energy. pos should be a matrix containing the positions of  all the atoms, 
 * L is the length of the supercell and N is the number of atoms.
 *
 * ****************************************************************************/
void calculate(
    double *potential, 
